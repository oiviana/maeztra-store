export default function Collection(){
    ...
    return(
        <div className="flex flex-col lg:flex-row py-2 px-7 gap-8 justify-center items-center">
            ...
            <div className="overflow-hidden rounded-md h-[184px] md:h-[300px] lg:h-[480px] lg:w-[1114px]">
                <img src="/images/collection/banner.png" className="w-full h-full object-cover" alt=""/>
            </div>
        </div>
    );
}